...
namespace LogiTrack.Core.Contracts
{
    public interface IRequestService
    {
        ...
        Task<IEnumerable<RequestsForSearchViewModel>> GetRequestsForLogisticsAsync(bool isApproved, bool sharedTruck, DateTime? startDate= null, DateTime? endDate = null, double? minWeight = null, double? maxWeight = null, decimal? minPrice = null, decimal? maxPrice = null, string? pickupAddress = null, string? deliveryAddress = null);
        ...
        Task<List<RequestsDetailsForLogisticsViewModel>> GetPendingRequestsAsync(bool sharedTruck, DateTime? startDate= null, DateTime? endDate = null, double? minWeight = null, double? maxWeight = null, double? minVolume = null, double? maxVolume = null, string? pickupAddress = null, string? deliveryAddress = null);
        Task<PendingRequestDetailsViewModel?> GetPendingRequestDetailsAsync(int id);
        Task<(string offerNumber, string requestNumber)> MakeOfferAsync(int requestId, decimal price);
        Task<(decimal, decimal)> GetProfitAndLossForDeliveryAsync(int deliveryId);
    }
}
