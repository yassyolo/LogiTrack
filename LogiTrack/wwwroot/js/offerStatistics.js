    ...
    await fetchAndRenderDualAxisChart('/Logistics/GetDifferencesInOfferPrices', dualAxisChart);
    ...
    await fetchAndRenderCargoRatioChart('/Logistics/GetCargoRatios', cargoRatioChart);
        } catch (error) {
