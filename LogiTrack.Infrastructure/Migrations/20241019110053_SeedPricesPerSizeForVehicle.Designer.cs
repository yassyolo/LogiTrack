...
namespace LogiTrack.Infrastructure.Migrations
{
    ...
    [Migration("20241019110053_SeedPricesPerSizeForVehicle")]
    partial class SeedPricesPerSizeForVehicle
    {
            ...
            modelBuilder.Entity("LogisticsSystem.Infrastructure.Data.DataModels.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InvoiceDate = new DateTime(2024, 10, 19, 11, 0, 52, 417, DateTimeKind.Utc).AddTicks(5454),
            ...
            modelBuilder.Entity("LogisticsSystem.Infrastructure.Data.DataModels.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OfferDate = new DateTime(2024, 10, 18, 11, 0, 52, 421, DateTimeKind.Utc).AddTicks(5910),
            ...
            modelBuilder.Entity("LogisticsSystem.Infrastructure.Data.DataModels.Request", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoType = "Standard",
                            ClientCompanyId = 1,
                            CreatedAt = new DateTime(2024, 10, 19, 14, 0, 52, 428, DateTimeKind.Local).AddTicks(6865),
                        ...
                        new
                        {
                            ...
                            CargoType = "Standard",
                            ClientCompanyId = 1,
                            CreatedAt = new DateTime(2024, 10, 19, 14, 0, 52, 428, DateTimeKind.Local).AddTicks(6935),
                        ...
                        new
                        {
                            ...
                            CargoType = "Standard",
                            ClientCompanyId = 1,
                            CreatedAt = new DateTime(2024, 10, 19, 14, 0, 52, 428, DateTimeKind.Local).AddTicks(6946),
                        ...
                        new
                        {
                            ...
                            CargoType = "Standard",
                            ClientCompanyId = 1,
                            CreatedAt = new DateTime(2024, 10, 19, 14, 0, 52, 428, DateTimeKind.Local).AddTicks(6950),
            ...
            modelBuilder.Entity("LogiTrack.Infrastructure.Data.DataModels.CashRegister", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 200m,
                            DateSubmitted = new DateTime(2024, 10, 19, 11, 0, 51, 921, DateTimeKind.Utc).AddTicks(8692),
                            DeliveryId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Amount = 50m,
                            DateSubmitted = new DateTime(2024, 10, 19, 11, 0, 51, 921, DateTimeKind.Utc).AddTicks(8694),
                            DeliveryId = 1,
            ...
            modelBuilder.Entity("LogiTrack.Infrastructure.Data.DataModels.Driver", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 35,
                            IsAvailable = false,
                            LicenseExpiryDate = new DateTime(2026, 10, 19, 11, 0, 51, 936, DateTimeKind.Utc).AddTicks(8282),
                        ...
                        new
                        {
                            ...
                            Age = 32,
                            IsAvailable = true,
                            LicenseExpiryDate = new DateTime(2027, 10, 19, 11, 0, 51, 936, DateTimeKind.Utc).AddTicks(8285),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "236704ce-6621-4b54-aae6-f574623f8bc3",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "23f95f88-97d1-4ed3-8052-ad57048e96fd",
                            Name = "ClientCompany",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8aaf4106-d583-41cd-9285-2a47846db3ac",
                            Name = "Secretary",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7d916bbf-3d7f-49e3-84c0-aa2a75f891e2",
                            Name = "Speditor",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "28da5387-d989-4b0f-8fd9-47e76436482f",
                            Email = "logistics@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEMGz+de4nrpU8/qKS7xo5P9MJlCI6IAL1hZNHrhSW2hS/jDJhYqiZTE1D3ux/nVvuw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "84ec99d5-3f4d-4b59-82a4-b26abe8d1c0a",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3e130086-bfae-48dd-b607-d7510aa8a410",
                            Email = "clientcompany1@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAECmq19fivSMazXU9GwXZjFuoJve0O5ym7N99g9TPr0bLo4hSrhpyBCJOJz463ifUug==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d14cd0e0-262e-42cb-9cd3-7cc43e34dbcd",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3908c448-c10b-48dc-8435-1c73451d4012",
                            Email = "secretary@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEO+VsskGbpeYW5yHQGVU12S910ry+elfswx2cZyw/jLNYv7pkc7K35V1NHaqN7J2YA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8d7c6de5-d4d4-46e8-aa14-b21172099ecc",
                            TwoFactorEnabled = false,
                            UserName = "secretary"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8470c424-392c-4e98-a5ee-1aa462ad5c40",
                            Email = "speditor@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEOo3173yDPtDoD2o1SpNlKDqgagL0KuoK5AGm1fsXPTc+A8O+FmHkdkyfMfPYUezng==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6cda594f-dc0e-4bfb-a4b4-3202961a84fa",
                            TwoFactorEnabled = false,
                            UserName = "speditor"
                        });
                });
